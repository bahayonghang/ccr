...
Initialize a Trellis-managed development session. Official Kimi Code supports project [agents](https://www.kimi.com/code/docs/en/kimi-code-cli/customization/agents) and [hooks](https://www.kimi.com/code/docs/en/kimi-code-cli/customization/hooks.html). **This repository** does not install project Kimi agents or hooks; start still uses a manual pull prelude:
