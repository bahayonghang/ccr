...
///
/// // 读取配置文件
/// let config: Config = ccr_core::core::fileio::read_toml(Path::new("config.toml"))?;
/// # Ok::<(), ccr_core::core::error::CcrError>(())
/// ```
...
///
/// // 写入配置文件
/// ccr_core::core::fileio::write_toml(Path::new("config.toml"), &config)?;
/// # Ok::<(), ccr_core::core::error::CcrError>(())
/// ```
