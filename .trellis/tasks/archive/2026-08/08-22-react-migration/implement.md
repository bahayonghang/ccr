...
- [x] `08-22-regression-release` 的 AC1–AC15 全部满足。AC6 按用户授权不做真实签到；AC13 JS 堆 1.295 见 `ac13-residual.md`。
...
- [x] CSP、窗口 chrome、启动恢复已验证。WAF 真实签到按用户 2026-08-25 授权关闭（`waiver-waf-ac6-ac9.md`）。
...
- [x] 父任务 `prd.md` 的 AC1–AC23 全部满足。AC9 按用户授权在无真实签到的情况下关闭。AC18/AC19 见 `08-22-regression-release/perf-react-after.md` 与 `bundle-reset.md`。
...
| 7    | 15 `regression-release`       | 已完成 | 发布门 ✅ 2026-08-25（AC9 用户授权无真实签到关闭） |
...
- [x] 工件评审后已 `task.py start`；父任务与子任务均已归档。
