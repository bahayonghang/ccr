...
This repository does NOT auto-inject task context via hook (official Grok hooks exist; this repo uses pull). Before doing anything else, you MUST load context yourself.
...
Grok Build officially supports hooks; **this repository** does not install them, so it does not auto-inject SessionStart task context. Always pull context as required below.
