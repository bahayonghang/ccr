...
Initialize a Trellis-managed development session. Official Grok Build supports [agents](https://docs.x.ai/build/features/subagents) and [hooks](https://docs.x.ai/build/features/hooks). **This repository** does not install Grok session-start hooks; this command still uses a manual pull prelude:
