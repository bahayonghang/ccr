...
| Grok Build | `--grok` | `.grok/` | `.grok/skills/` | `.grok/agents/` | official hooks exist; this repo: pull-based prelude + flat `.grok/commands/trellis-*.md` (no project hooks installed) |
| Kimi Code | `--kimi` | `.kimi-code/` | `.agents/skills/` (shared) + `.kimi-code/skills/` | official project agents exist; this repo: skills under `.kimi-code/skills/` dispatch built-in `coder` (no project agents installed) | official hooks exist; this repo: pull-based prelude (no project hooks/settings installed) |
