...
- ✅ **Real-time Cost Tracking** - Precisely record the cost of each API call
- ✅ **Multi-dimensional Statistics** - Analyze by time, model, and project groupings
- ✅ **Visual Dashboard** - Intuitive data presentation
- ✅ **Trend Analysis** - View daily cost trends
...
1. Start CCR UI
2. Click "Statistics" or "统计分析" in the left navigation bar
3. Visit `http://localhost:5173/stats`

### Via Dashboard

1. Find the "📊 Statistics Analysis" card on the Dashboard homepage
...
- 📈 Cost trend line chart (Chart.js)
