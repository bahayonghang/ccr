<template>
  <div class="skill-import-gh-panel">
    ...
    <div class="form-panel-body">
      <p class="import-hint">
        Import skills from a GitHub repository. Enter the repo URL or <code>owner/repo</code> shorthand.
      </p>

      <div class="form-field">
        <label class="form-field__label">GitHub repository</label>
        <input
          v-model="repoUrl"
          type="text"
      ...
      <div class="form-panel-footer">
        ...
        <button
          ...
          :disabled="!repoUrl.trim() || selectedPlatforms.length === 0"
          @click="handleImport"
        >
          <SIcon
            name="Github"
...
function handleImport() {
  if (repoUrl.value.trim()) emit('import', repoUrl.value.trim())
}
</script>

<style scoped>
.skill-import-gh-panel {
  height: 100%;
  display: flex;
