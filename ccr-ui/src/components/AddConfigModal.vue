...
<template>
  ...
  >
    ...
    <div class="h-px bg-border-subtle my-6" />
        ...
        <div class="w-full">
          ...
          <div class="relative">
            <select
              ...
              class="w-full bg-bg-elevated border border-border-default rounded-xl px-4 py-2.5 text-sm text-text-primary focus:outline-none focus:ring-2 focus:ring-accent-primary/20 appearance-none hover:border-border-strong cursor-pointer"
            >
              <option value="">
