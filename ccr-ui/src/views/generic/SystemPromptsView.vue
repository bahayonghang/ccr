<template>
  <div class="system-prompts-view">
    <div class="system-prompts-view__shell">
      <ModuleSubnav :module="subnavModule" />

      <header class="system-prompts-view__header">
        <div>
          <p>{{ t(`systemPrompts.platforms.${platform}`) }}</p>
          <h1>{{ t('systemPrompts.title') }}</h1>
          <span>{{ t('systemPrompts.description') }}</span>
        </div>
        <SIcon
          name="ScrollText"
          size="w-8 h-8"
...
.system-prompts-view__header p,
.system-prompts-view__header h1,
.system-prompts-view__header span,
