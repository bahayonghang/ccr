export default {
  ...
  claudeProfiles: {
    ...
    // Header
    title: 'Profile 配置管理',
    subtitle: '管理 Claude Code 完整配置快照，一键切换不同工作环境',
    back: '返回',
    ...
    quickSwitch: '快速切换',
    // Empty state
    emptyTitle: '还没有 Profile 喵～',
    emptyDesc: '创建第一个 Profile，从当前配置自动快照',
    ...
    // Modal
    editProfileTitle: '编辑 Profile',
    newProfileTitle: '新建 Profile',
    nameLabel: '名称 *',
    ...
    snapshotFromCurrent: '从当前配置自动创建快照',
    snapshotHint: '自动捕获 settings.json、MCP 服务器、Output Styles 和 Budget 配置',
    reSnapshot: '重新从当前配置快照',
    cancel: '取消',
    save: '保存',
    create: '创建',
    // Confirm & Error
    confirmDelete: '确定要删除 Profile "{name}" 吗？',
    confirmApply: '确定要应用 Profile "{name}" 吗？这将覆盖当前配置。',
    operationFailed: '操作失败',
    deleteFailed: '删除失败',
    applyFailed: '应用失败',
  },
