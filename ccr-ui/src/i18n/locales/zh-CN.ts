export default {
  ...
  claudeProfiles: {
    ...
    advancedModelsDescription: '对应 ANTHROPIC_DEFAULT_*_MODEL 与 CLAUDE_CODE_*；仅在 DeepSeek 等服务需要分别指定 Opus / Sonnet / Haiku 时填写。',
    advancedModelsToggleExpand: '展开高级模型映射',
    advancedModelsToggleCollapse: '收起高级模型映射',
    defaultOpusModelLabel: 'Opus 默认模型',
    defaultOpusModelPlaceholder: '例如：deepseek-v4-pro',
    defaultOpusModelHelper: '写入 ANTHROPIC_DEFAULT_OPUS_MODEL；DeepSeek 等服务通过它接管 Opus 路径。',
    ...
    subagentModelHelper: '写入 CLAUDE_CODE_SUBAGENT_MODEL，用于 Claude Code 内部 Subagent 任务。',
    effortLevelLabel: '思考强度',
    effortLevelPlaceholder: '例如：max / high / medium / low',
    effortLevelHelper: '写入 CLAUDE_CODE_EFFORT_LEVEL；自由文本，不强制枚举。',
