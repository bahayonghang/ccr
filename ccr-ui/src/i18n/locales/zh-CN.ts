export default {
  ...
  skillsExt: {
    versionHistory: {
      title: '版本历史',
      subtitle: '{count} 个快照 · 最多 50 (FIFO)',
      takeSnapshot: '手动打标',
      refresh: '刷新',
      empty: '暂无快照。编辑 SKILL.md 并保存即可自动生成快照。',
      rollback: '回滚',
      diff: '对比',
      baseActive: '◉ 基准',
      baseInactive: '○ 基准',
      snapshotPrompt: '快照说明',
      defaultMessage: '手动打标',
      rollbackConfirm: '回滚到 {id}（{message}）？回滚前会自动保存当前未提交的状态。',
    },
    diff: {
      empty: '选择两个快照进行对比。',
      same: '{count} 行未变',
    ...
    trash: {
      title: '回收站',
      subtitle: '{count} 个条目 · 7 天后自动清理',
      empty: '回收站为空。',
      restore: '恢复',
      deleteForever: '永久删除',
      deletedAt: '删除于 {time}',
      expiresAt: '{time} 自动清理',
      purgeConfirm: '确认永久删除此 skill？此操作无法恢复。',
    },
    toggle: {
      enabled: '已启用',
      disabled: '已禁用',
