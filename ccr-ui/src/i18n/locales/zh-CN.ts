export default {
  ...
  home: {
    ...
    posterLead: '把命令、配置与平台状态收拢到一个安静但高效的控制台。',
    posterDescription: '从这里发起命令、整理 Profiles、同步工作区，并在进入详情前先看清当前平台脉冲。',
    statusReadyLabel: '系统状态',
    statusCliLabel: 'CLI 在线',
    visualEyebrow: '运行脉冲',
    visualTitle: 'Command fabric',
    visualBadge: 'online',
    usagePreviewEyebrow: '活动预览',
    usagePreviewTitle: '滚动查看完整 usage 报告',
    actionsEyebrow: '立即操作',
    actionsTitle: 'Start a task',
    actionsDescription: '把高频动作压缩成一条快速操作带，不用先钻进子页面再找入口。',
    platformsEyebrow: '平台控制',
    platformsTitle: 'Manage your toolchain',
    platformsDescription: '重点平台放大展示，其余节点收进 rail，让安装态与版本态先被看见。',
    platformFeatureLabel: '重点节点',
    systemActivity: '系统活动',
    usageSectionTitle: 'Usage signal',
    usageSectionDescription: '完整数据仍在下方按需加载，但首屏先给你一个轻量趋势预告。',
    fullReport: '查看完整报告',
    operational: '正常运行喵',
