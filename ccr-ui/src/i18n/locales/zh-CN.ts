export default {
  ...
  home: {
    ...
    qoderTitle: 'QODER',
    qoderDesc: '管理 Qoder 的 MCP、Commands、Subagents 与 Hooks。',
    qoderStats: '工作流',
  ...
  converter: {
    title: '配置转换器',
    description:
      '支持多种 CLI 配置格式之间的互相转换，包括 Claude Code、Codex、Gemini、Qwen、Qoder 等',
    backToHome: '返回首页',
    sourceFormat: '源格式',
    targetFormat: '目标格式',
    sourceConfig: '源配置',
  ...
  sync: {
    ...
    platformSelection: {
      ...
      qoder: 'Qoder',
      qoderDescription: 'Qoder CLI 配置和数据',
    },
  ...
  qoder: {
    overview: {
      ...
      backToHome: '返回首页',
      features: '功能模块',
      feature1: '通过 `.qoder/commands` 管理项目级 Commands。',
      feature2: '通过 `.qoder/agents` 管理可复用的 Subagents。',
      feature3: '通过 `~/.qoder.json` 与 `.mcp.json` 接入 MCP 服务器。',
      feature4: '通过 `.qoder/settings.json` 管理 Notification Hooks 与 Memory。',
      featureTitle: '💡 Qoder CLI 特性',
      tags: {
    ...
    agents: {
      title: 'Subagents',
      description: 'Qoder Subagent Markdown 配置和管理',
      badge: '🤖 Subagent',
      folders: {
        label: '文件夹',
        all: '全部',
      ...
      addAgent: '添加 Subagent',
      editAgent: '编辑 Subagent',
      nameLabel: '名称 *',
      namePlaceholder: '例如: code-reviewer',
      folderLabel: '文件夹',
      folderPlaceholder: '留空则为根目录',
      descriptionLabel: '描述',
      descriptionPlaceholder: '简短描述此 Subagent 的职责',
      instructionsLabel: '提示词 *',
      instructionsPlaceholder: '输入 Subagent 的系统提示词...',
      enabledLabel: '启用此 Subagent',
      searchPlaceholder: '搜索 Subagent 名称、说明或提示词...',
      searchResults: '找到 <strong>{count}</strong> 个匹配的 Subagent',
      loading: '加载中...',
      emptyState: '暂无 Subagent 配置',
      noResults: '未找到匹配的 Subagent',
      noResultsHint: '尝试使用其他关键词搜索',
      disabledBadge: '已禁用',
      enable: '启用',
      disable: '禁用',
      save: '保存',
      add: '添加',
      deleteConfirm: '确定要删除 Subagent "{name}" 吗？',
      validation: {
        required: '请填写必填字段',
      },
      messages: {
        ...
        addSuccess: '✓ Subagent 添加成功',
        deleteSuccess: '✓ Subagent 删除成功',
        operationFailed: '操作失败: {error}',
        deleteFailed: '删除失败: {error}',
        toggleFailed: '切换状态失败: {error}',
      },
    ...
    plugins: {
      title: 'Hooks',
      description: 'Qoder Notification hooks 配置管理',
      badge: '🪝 Hooks',
      addPlugin: '添加 Hook',
      editPlugin: '编辑 Hook',
      nameLabel: '名称',
      namePlaceholder: '自动生成',
      idLabel: '事件',
      ...
      configHint: 'Qoder 当前按 Notification 事件执行 shell command。',
      enabledLabel: '启用此 Hook',
      searchPlaceholder: '搜索 Hook 命令...',
      searchResults: '找到 <strong>{count}</strong> 个匹配的 Hook',
      loading: '加载中...',
      emptyState: '暂无 Hook 配置',
      noResults: '未找到匹配的 Hook',
      noResultsHint: '尝试使用其他关键词搜索',
      disabledBadge: '已禁用',
      enable: '启用',
      disable: '禁用',
      save: '保存',
      add: '添加',
      deleteConfirm: '确定要删除 Hook "{name}" 吗？',
      validation: {
        required: '请填写必填字段',
        invalidJson: '命令配置格式错误',
      },
      messages: {
        loadFailed: '加载 Hooks 失败',
        updateSuccess: '✓ Hook 更新成功',
        addSuccess: '✓ Hook 添加成功',
        deleteSuccess: '✓ Hook 删除成功',
        operationFailed: '操作失败: {error}',
        deleteFailed: '删除失败: {error}',
        toggleFailed: '切换状态失败: {error}',
      },
    ...
    slashCommands: {
      title: 'Commands',
      description: 'Qoder Markdown commands 管理',
      badge: '⌨️ 命令',
      folders: {
        label: '文件夹',
        all: '全部',
