export default {
  ...
  claudeProfiles: {
    ...
    subtitle: 'Manage Claude Code configuration snapshots, switch environments with one click',
    back: 'Back',
    ...
    snapshotScope: 'Snapshot Includes',
    snapshotScopeValue: 'Settings / MCP / Styles / Budget',
    // Quick switch
    quickSwitch: 'Quick Switch',
    // Empty state
    emptyTitle: 'No Profiles Yet',
    emptyDesc: 'Create your first profile by snapshotting the current configuration',
    ...
    snapshotFromCurrent: 'Snapshot from current configuration',
    snapshotHint: 'Automatically captures settings.json, MCP servers, Output Styles, and Budget',
    reSnapshot: 'Re-snapshot from current configuration',
    cancel: 'Cancel',
    save: 'Save',
    create: 'Create',
    // Confirm & Error
