export default {
  ...
  common: {
    ...
    historyPanel: {
      ...
      emptyDescription: 'Operations will appear here.',
    ...
    updateModal: {
      ...
      confirmMessage: 'Update CCR now?',
      notesTitle: 'Notes:',
      noteDuration: 'The update may take a few minutes',
      noteDoNotClose: 'Do not close this window during the update',
      noteRefresh: 'Refresh the page after the update completes',
      noteSaveWork: 'Save current work before updating',
      runningMessage: 'Running update, please wait...',
      successMessage: 'CCR updated successfully!',
      successHint: 'The update is complete. Refresh the page to use the latest version.',
      viewLog: 'View update log',
      errorMessage: 'An error occurred during the update. Review the error details and try again.',
      viewDetailedLog: 'View detailed log',
      confirmAction: 'Confirm update',
      runningHint: 'Updating. Do not close this window...',
      refreshPage: 'Refresh page',
      outputStart: 'Starting CCR update...\n',
      outputCompleted: 'Update complete!',
      outputError: 'Update failed',
      outputUnexpectedError: 'An error occurred during the update',
    },
  },
  ccrControl: {
  ...
  checkin: {
    ...
    progress: {
      runningTitle: 'Running check-in',
      manualWafTitle: 'Check-in complete · Manual WAF action required',
      accountProgress: '{current} / {total} accounts',
      currentAccount: 'Checking in: {account}',
      manualWafSummary:
        '{count} account(s) are still blocked by WAF. Open Providers and fetch the cookie manually.',
      allTasksCompleted: 'All tasks completed',
      logTitle: 'Check-in log',
      waiting: 'Waiting to start check-in...',
      recoveryFailed: 'Auto-recovery failed',
    },
    waf: {
    ...
    records: {
      ...
      loadFailed: 'Failed to load records. Try again.',
      exportFailed: 'Export failed: {error}',
      failedHistoryTitle: 'Failed History ({count})',
      failedHistoryHint: 'Expand for details',
      allProviders: 'All providers',
      filter: 'Filter',
      reset: 'Reset',
      export: 'Export',
      loading: 'Loading...',
      emptyFailed: 'No failed records',
      keywordPlaceholder: 'Account / ID / message',
      ...
      rewardAndBalance: 'Reward / Balance Delta',
      balanceBeforeAfter: 'Balance Before / After',
      balanceSeparator: ' -> ',
      cookieExpiredFix: 'Update Cookie',
    },
    providers: {
      builtinTitle: 'Built-in Relays',
      builtInBadge: 'Built-in',
      add: 'Add',
      autoCheckin: 'Auto check-in',
      supportsCheckin: 'Check-in supported',
      noCheckin: 'No check-in',
      requiresWafBypass: 'WAF bypass required',
      addedTitle: 'Added Providers',
      customAdd: 'Add custom provider',
      emptyTitle: 'No provider configured',
      emptyHint: 'Add one from the built-in relays above or create a custom provider.',
      checkinPath: 'Check-in path: {path}',
      wafTitle: 'WAF Verification',
      cachedCookie: 'Cookie cached',
      uncachedCookie: 'Cookie not cached',
      wafMessage:
        'Sites like AnyRouter require a WAF cookie before check-in, and the browser login plus check-in request must use the same proxy or network exit.',
      wafHint:
        'Suggested flow: save session and api_user first, open the login page to finish the challenge, then return to the check-in page and retry.',
      loading: 'Fetching...',
      reloadCookie: 'Fetch again',
      getCookie: 'Get Cookie',
      editProvider: 'Edit Provider',
      addProvider: 'Add Provider',
      nameLabel: 'Name *',
      baseUrlLabel: 'Base URL *',
      checkinPathLabel: 'Check-in Path',
      balancePathLabel: 'Balance Path',
      authHeaderLabel: 'Auth Header',
      authPrefixLabel: 'Auth Prefix',
      cancel: 'Cancel',
      save: 'Save',
    },
    oauthWizard: {
      providerLabel: 'Select provider',
      loginMethodLabel: 'Select login method',
      oauthNotConfigured: 'This provider has not configured an OAuth client ID yet.',
      loadingAuthorizeUrl: 'Fetching authorization link...',
      backToSelection: 'Back and choose again',
      openInBrowserHint: 'Open the following link in your browser to complete authorization:',
      copied: 'Copied',
      copy: 'Copy',
      ...
      defaultAccountName: '{provider} account',
      unsetValue: '(Not set)',
      oauthTypes: {
        linuxdo: 'LinuxDo',
        github: 'GitHub',
      ...
      summary: {
        ...
        cookieCountValue: '{count} cookies',
        apiUser: 'API User',
      },
      errors: {
        fetchAuthorizeUrlFailed: 'Failed to fetch authorization link',
        networkRequestFailed: 'Network request failed',
        unrecognizedCredentialsFormat: 'Unrecognized credentials format',
        emptyCookies: 'Cookies are empty. Check the input format.',
        parseFailed: 'Failed to parse credentials',
  ...
  dashboard: {
    ...
    usage: {
      ...
      chartAria: '{days}-day window, {requests} requests, platforms: {platforms}',
  ...
  claudeCode: {
    ...
    observer: {
      ...
      chart: {
        ...
        preparingHeatmap: 'Preparing heatmap…',
        topTools: 'Top tools',
  ...
  claudeProfiles: {
    title: 'Claude Profiles Management',
    ...
    advancedModelsConfiguredCount: '{count} configured',
    ...
    defaultFableModelLabel: 'Fable default model',
    defaultFableModelPlaceholder: 'e.g. glm-5.2[1m]',
    defaultFableModelHelper: 'Sets ANTHROPIC_DEFAULT_FABLE_MODEL.',
    defaultOpusModelNameLabel: 'Opus display name',
    defaultSonnetModelNameLabel: 'Sonnet display name',
    defaultHaikuModelNameLabel: 'Haiku display name',
    defaultFableModelNameLabel: 'Fable display name',
    defaultModelNamePlaceholder: 'e.g. GLM-5.2',
    defaultModelNameHelper:
      'Sets the tier ANTHROPIC_DEFAULT_*_MODEL_NAME. Only affects the /model picker label, not the actual request model ID.',
    ...
    validationNameRequired: 'Profile name is required',
    validationJump: 'Jump',
    providerTemplateLabel: 'Provider template',
    providerTemplateHelper: 'Fill non-secret provider, endpoint, and model defaults from a reusable template.',
    templateAuthModeSwitched: 'Auth mode switched to api_key for this third-party endpoint.',
    ...
    quickRailModifierHint: '{modifier}+number keys to quick switch',
    quickRailMore: '+{count} more',
    pinProfile: 'Pin {name}',
    unpinProfile: 'Unpin {name}',
    pinLimitReached: 'You can pin up to 8 profiles',
    overflowMenu: 'More actions',
    confirmDeleteBackupFootnote: 'Before deleting, a snapshot of the current config is rotated into ~/.ccr/backups/claude/. There is no in-app restore entry; to restore, manually copy the snapshot contents back into profiles.toml.',
    groups: {
      enabled: 'Enabled',
      disabled: 'Disabled',
    },
    statStrip: {
      ...
      healthTitle: 'Health',
      healthHintOk: 'No config issues',
      healthHintIssues: '{count} config issues',
    },
    toolbar: {
    ...
    inspector: {
      ariaLabel: 'Profile inspector sidebar',
      previewTitle: 'Profile preview',
      editAction: 'Edit this Profile',
      previewEmpty: 'No profile to preview',
      previewEmptyHint: 'Hover or focus a profile in the list to preview it; the current profile is shown by default.',
      currentBadge: 'Current',
      diffTitle: 'Differences from current config',
      sessionWrite: 'Written this session · {time}',
  ...
  settingsRaw: {
    ...
    continue: 'Continue',
    plaintextNotice: 'This is the verbatim file on disk and may contain plaintext credentials. Its content is never stored in browser storage or logs.',
    filePath: 'Configuration file',
    pathPending: 'Resolving path',
    unsaved: 'Unsaved changes',
    save: 'Save source',
    saving: 'Saving...',
    saveSuccess: 'Source file saved',
    saveFailed: 'Failed to save source file',
    reload: 'Reload',
    loading: 'Reading source file...',
    loadFailed: 'Failed to read source file',
    editorLoading: 'Loading editor...',
    editorLabel: 'Configuration source editor',
    conflictTitle: 'The file changed outside CCR',
    conflictMessage: 'This editor version is stale. Reload the file from disk before merging your changes.',
    unsupportedEnvironment: 'Direct source editing is not available for remote execution environments.',
    layersTitle: 'Configuration layers',
    layersDescription: 'Configuration sources currently discoverable in platform priority order.',
    projectContextRequired: 'Requires project context and is not managed here',
    editable: 'Editable',
    readOnly: 'Read only',
    discardTitle: 'Discard unsaved changes?',
    discardMessage: 'Leaving source mode will discard the current unsaved content.',
    discard: 'Discard changes',
  },
  profilesRaw: {
    edit: 'Edit TOML',
    title: 'Edit profiles.toml',
    close: 'Close editor',
    openWarningTitle: 'View plaintext Profiles configuration',
    openWarningMessage: 'profiles.toml may contain API keys, tokens, and other plaintext credentials. Its content stays only in this page memory. Continue only in a private environment.',
    continue: 'Continue editing',
    plaintextNotice: 'This is the verbatim disk file and may contain plaintext credentials. Its content is never written to browser storage or logs.',
    unsaved: 'Unsaved changes',
    reload: 'Reload',
    save: 'Save TOML',
    saving: 'Saving...',
    loading: 'Reading profiles.toml...',
    loadFailed: 'Failed to read profiles.toml',
    saveFailed: 'Failed to save profiles.toml',
    saveSuccess: 'Saved {count} Profiles',
    conflictTitle: 'The file changed outside CCR',
    conflictMessage: 'This editor version is stale. Reload the disk file before merging your changes.',
    activationTitle: 'The current Profile will become invalid',
    activationMessage: 'The active Profile "{name}" is missing from the new content. Save anyway?',
    activationConfirm: 'Save anyway',
    discardTitle: 'Discard unsaved changes?',
    discardMessage: 'Closing the TOML editor will discard the current unsaved content.',
    discard: 'Discard changes',
  },
  systemPrompts: {
    nav: 'System Prompts',
    title: 'System Prompts',
    description: 'Manage the user-level global instruction files read by this platform.',
    filesTitle: 'Instruction files',
    filesDescription: 'Select a file to edit its verbatim disk content.',
    exists: 'Created',
    missing: 'Not created',
    create: 'Create file',
    creating: 'Creating...',
    ...
    reload: 'Reload',
    unsaved: 'Unsaved changes',
    emptySelection: 'Select an instruction file to begin editing.',
    loading: 'Reading system prompts...',
    loadFailed: 'Failed to read system prompts',
    saveFailed: 'Failed to save system prompts',
    createFailed: 'Failed to create system prompt',
    saveSuccess: 'System prompt saved',
    createSuccess: 'System prompt file created',
    conflictTitle: 'The file changed outside CCR',
    conflictMessage: 'Reload the disk version before merging your changes.',
    sizeWarning: 'This file exceeds 64 KiB. The platform may read only part of it.',
    codexLimit: 'Codex project instructions default to a 32 KiB read limit.',
    modified: 'Modified {time}',
    bytes: '{count} bytes',
    claudeHierarchyTitle: 'Claude memory hierarchy',
    claudeHierarchyDescription: 'managed → project → user → local. This page edits only the user-level CLAUDE.md.',
    rulesTitle: 'User rules (read only)',
    rulesEmpty: 'No ~/.claude/rules/*.md files found.',
    antigravityNote: 'This manages the default ~/.gemini/GEMINI.md. If context.fileName overrides it, maintain that custom file directly on disk.',
    discardTitle: 'Discard unsaved changes?',
    discardMessage: 'Switching files or leaving this page will discard the current unsaved content.',
    discard: 'Discard changes',
    files: {
      claudeUserMemory: 'Claude user memory',
      codexAgents: 'Codex global AGENTS.md',
      geminiMd: 'Antigravity GEMINI.md',
      opencodeAgents: 'OpenCode global AGENTS.md',
    },
    platforms: {
      claude: 'Claude Code',
      codex: 'Codex',
  ...
  settings: {
    ...
    appearance: {
      ...
      theme: {
        eyebrow: 'Theme',
        title: 'Light, dark, and surface family',
        description:
          'When following the system, light and dark come from the OS. Surface family stays independent of that.',
      ...
      typography: {
        eyebrow: 'Typography',
        title: 'Interface and data fonts',
        description:
          'Interface copy uses sans. Numbers and code use a monospace track. Your choice sits ahead of the built-in stack.',
        ...
        previewSampleUi: 'Chinese and Latin mixed preview AaBbGg',
        previewSampleCode: '16.8K  3.9B  $128.40  +12%',
        resetHint:
          'Leave empty to fall back to the built-in font stack. Missing glyphs cascade, so tofu boxes do not appear.',
      },
    },
    language: {
      eyebrow: 'Language',
  ...
  usage: {
    ...
    dashboard: {
      ...
      providers: {
        eyebrow: 'Provider Attribution',
        title: 'Usage by relay provider',
        subtitle:
          'Split Claude and Codex token/cost totals by the relay provider stamped by llmusage from CCR activation history.',
        totalCost: 'Provider Cost',
        costBasis: '≈ official-equivalent price',
        unsupportedTitle: 'Provider attribution is unavailable',
        unsupportedHint:
        ...
        summaryTokenMix: '{input} input / {output} output',
        summaryRequests: 'Requests',
        unattributed: 'Unattributed',
        unattributedHint: 'before the first activation window or after a clear event',
        empty: 'No provider-attributed usage in this window',
      },
      chart: {
  ...
  codex: {
    ...
    agents: {
      ...
      invalidJsonWithLabel: '{label} must be valid JSON: {error}',
      ...
      followParentSession: 'Follow parent session',
      rawTomlEmpty: 'Raw TOML cannot be empty',
      sources: {
        ...
        rescan: 'Rescan',
        remove: 'Remove',
        trackedInstalls: 'Tracked Installs',
        sync: 'Sync',
        overwrite: 'Overwrite',
        ...
        preview: 'Preview',
        install: 'Install',
        previewTitle: 'Remote Agent Preview',
        installTitle: 'Install Remote Agent',
        targetName: 'Target name',
        targetNamePlaceholder: 'Leave empty to keep the source name',
        ...
        confirm: {
          ...
          removeMessage: 'Remove this GitHub source? Existing installed agents will be kept.',
          overwriteTitle: 'Overwrite local changes',
          overwriteMessage: 'Replace the local tracked file with the upstream version?',
          untrackTitle: 'Stop tracking install',
          untrackMessage: 'Remove provenance tracking for this install and keep the local file?',
        },
        messages: {
          addSuccess: 'Source added and scanned',
          rescanSuccess: 'Source rescanned',
          removeSuccess: 'Source removed',
          installSuccess: 'Remote agent installed',
          syncSuccess: 'Tracked install synced',
          overwriteSuccess: 'Upstream version applied',
          acceptLocalSuccess: 'Local changes accepted as baseline',
          untrackSuccess: 'Tracking removed',
        },
      },
      validation: {
        required: 'Please fill in required fields',
    ...
    profiles: {
      ...
      title: 'Codex Profiles Management',
      ...
      placeholders: {
        ...
        modelCatalogJson: 'e.g: ~/.codex/models.json',
      ...
      authModes: {
        ...
        provider_bearer_token: 'Provider Bearer Token',
        no_auth: 'No Auth',
      },
      authTokenHints: {
        ...
        provider_bearer_token:
          'The API key is written to the provider bearer-token field in Codex config.toml.',
      ...
      modelCatalogJsonHint:
        'The path is written to Codex unchanged; generate models.json with the official DeepSeek setup script.',
      ...
      pinLimitReached: 'You can pin up to 8 profiles',
      overflowMenu: 'More actions',
      confirmDeleteBackupFootnote: 'Before deleting, a snapshot of the current config is rotated into ~/.ccr/backups/codex/. There is no in-app restore entry; to restore, manually copy the snapshot contents back into profiles.toml.',
      loadFailedTitle: 'Failed to load Codex profiles',
      refreshFailedTitle: 'Failed to refresh Codex profiles',
      refreshFailedHint: 'The current list is preserved; retry later or keep browsing existing profiles.',
      retry: 'Retry',
      validationJump: 'Jump',
      empty: {
      ...
      statStrip: {
        ...
        configModeHint: 'Official {official} · Custom relay {custom}',
        healthTitle: 'Health',
        healthHintOk: 'No config issues',
        healthHintIssues: '{count} config issues',
      },
    ...
    auth: {
      ...
      tray: {
        ...
        available: 'Available',
        lastRefreshInline: ' · Last refreshed {time}',
  ...
  grok: {
    ...
    profiles: {
      title: 'Grok Profiles',
      subtitle: 'Manage redacted Grok runtime profiles and activation state.',
      back: 'Back to Grok',
      commandPaletteButton: 'Command',
      commandPaletteShortcut: 'Open command palette (Ctrl/Command+K)',
      overflowMenu: 'More actions',
      currentActive: 'Current active',
      officialBaseUrl: 'Official Grok runtime',
      quickSwitch: 'Quick switch',
      quickRailModifierHint: '{modifier}+number keys to quick switch',
      quickRailMore: '+{count} more',
      pinProfile: 'Pin {name}',
      unpinProfile: 'Unpin {name}',
      pinLimitReached: 'You can pin up to 8 profiles',
      loadFailedTitle: 'Failed to load Grok Profiles',
      refreshFailedTitle: 'Failed to refresh Grok Profiles',
      actions: {
        reload: 'Reload',
        exportSummary: 'Export redacted summary',
        add: 'Add profile',
        retry: 'Retry',
        off: 'Turn profile mode off',
        save: 'Save',
        apply: 'Apply',
        edit: 'Edit',
        delete: 'Delete',
      ...
      statStrip: {
        ...
        currentHint: 'Runtime activation intent',
        total: 'Profiles',
        totalHint: '{enabled} enabled · {disabled} disabled',
        authMode: 'Authentication',
        authModeHint: 'Credential shape of the active profile',
        healthTitle: 'Health',
        healthSummary: '{enabled} of {total} enabled · {issues} profile issues',
      },
      toolbar: {
        searchPlaceholder: 'Search name · URL · model · tag…',
        statusGroupLabel: 'Status filter',
        statusAll: 'All',
        statusActive: 'Current',
        statusEnabled: 'Enabled',
      ...
      empty: {
        title: 'No Grok profiles',
        hint: 'Create the first profile to manage Grok runtime settings.',
        noResults: 'No profile matches "{query}"',
        clearFilters: 'Clear filters',
      },
      groups: {
      ...
      fields: {
        ...
        contextWindow: 'Context window',
        supportsBackendSearch: 'Backend search',
        reasoningEffort: 'Reasoning effort',
        tags: 'Tags',
        enabled: 'Enabled',
      },
      ...
      authModes: {
        inline_api_key: 'Inline API key configured',
        env_key: 'Environment variable',
        session: 'Grok session authentication',
      },
      credentialActions: {
        preserve: 'Keep current credential',
        replace_api_key: 'Replace with API key',
        replace_env_key: 'Replace with environment key',
        clear: 'Clear credential',
      },
      editor: {
        createTitle: 'Add Grok profile',
        editTitle: 'Edit Grok profile',
        validationTitle: 'Resolve these fields before saving',
        identity: 'Identity',
        identityHint: 'Use a stable name and enough context to identify this runtime.',
        kindLocked: 'Profile type comes from the saved backend record and cannot be changed while editing.',
        connection: 'Connection and credentials',
        writeOnlyHint: 'Sensitive connection fields are write-only and never loaded back into this form.',
        keepBaseUrl: 'Leave blank to keep the existing Base URL unchanged.',
        baseUrlHint: 'Enter the complete third-party endpoint.',
      ...
      validation: {
        nameRequired: 'Profile name is required',
        modelRequired: 'A third-party profile requires a model',
        baseUrlRequired: 'A third-party profile requires a Base URL',
        credentialRequired: 'Choose an API key or environment key for a new third-party profile',
        apiKeyRequired: 'Enter the replacement API key',
        envKeyRequired: 'Enter the replacement environment variable name',
        contextWindow: 'Context window must be a positive integer',
      },
      confirm: {
        applyTitle: 'Apply Grok profile',
        applyMessage: 'Switch the Grok runtime to profile "{name}"?',
        offTitle: 'Turn Grok profile mode off',
        offMessage: 'Restore the native Grok configuration captured before profile mode was activated?',
        offDriftedMessage: 'Restore the entry configuration and clear the detected drift state?',
        deleteTitle: 'Delete Grok profile',
        deleteMessage: 'Delete profile "{name}"? This cannot be undone.',
        forceDeleteTitle: 'Turn profile mode off and delete',
        forceDeleteMessage: 'Profile "{name}" is active or drifted. Restore the entry configuration, then delete it?',
        forceDeleteAction: 'Turn off and delete',
        enableTitle: 'Enable Grok profile',
        enableMessage: 'Enable profile "{name}"?',
        disableTitle: 'Disable Grok profile',
        disableMessage: 'Disable profile "{name}"? It will remain stored but cannot be applied.',
      },
      messages: {
        loadFailed: 'Failed to load Grok Profiles',
        createSuccess: 'Grok profile created',
        updateSuccess: 'Grok profile updated',
        saveFailed: 'Failed to save the Grok profile',
        applySuccess: 'Applied Grok profile "{name}"',
        applyFailed: 'Failed to apply the Grok profile',
        offSuccess: 'Grok profile mode is off',
        offFailed: 'Failed to turn Grok profile mode off',
        deleteSuccess: 'Deleted Grok profile "{name}"',
        deleteFailed: 'Failed to delete the Grok profile',
        recoverySuccess: 'Rename recovery completed',
        recoveryFailed: 'Rename recovery failed',
        exportSuccess: 'Redacted Grok profile summary exported',
        unexpectedResponse: 'Grok returned an unexpected response',
      },
      driftBanner: {
        inactive: {
          title: 'Profile mode is inactive',
          description: 'Grok is using its native configuration.',
        },
        active: {
          title: 'Profile {name} is active',
          description: 'The managed runtime matches the selected profile.',
        },
        drifted: {
          title: 'Profile {name} has drifted',
          description: 'The runtime no longer matches the activation intent. Turn profile mode off to restore the entry configuration.',
        },
        unsafe_missing_entry_state: {
          title: 'Entry state is missing for {name}',
          description: 'Automatic recovery is disabled. Inspect the local Grok configuration before making destructive changes.',
        },
      },
      renameRecovery: {
        rename_apply_failed: {
          title: 'The new name was saved, but activation did not move',
          action: 'Retry applying the new name',
        },
        rename_cleanup_failed: {
          title: 'The new name is active, but the old entry remains',
          action: 'Retry deleting the old name',
        },
      },
      unsafeDelete: {
        title: 'Cannot safely delete {name}',
        manualRecovery: 'Automatic force deletion is unavailable. Inspect and restore {path}, then retry off or delete.',
      },
      commandPalette: {
        title: 'Grok Profiles command palette',
        eyebrow: 'Grok Profiles',
        placeholder: 'Type a command or profile name…',
        resultSummary: '{commands} commands · {profiles} profiles',
        groupCommands: 'Common commands',
        groupProfiles: 'Switch profile',
        ...
        empty: 'No matches',
        actionAdd: 'Add profile',
        actionReload: 'Reload profiles',
        actionOff: 'Turn profile mode off',
        actionApply: 'Switch to {name}',
      },
      inspector: {
        ariaLabel: 'Grok Profiles inspector sidebar',
        previewTitle: 'Profile preview',
        editAction: 'Edit this profile',
        previewEmpty: 'No profile to preview',
        previewEmptyHint: 'Hover or focus a profile in the list; the current profile is shown by default.',
        currentBadge: 'Current',
        diffTitle: 'Differences from current profile',
        sessionWrite: 'Written this session · {time}',
        distributionTitle: 'Distribution',
        providerSection: 'By provider',
        authSection: 'By authentication',
        tagsSection: 'Top tags',
        unknownProvider: 'Unspecified',
        noTags: 'No tags yet',
        auditTitle: 'Health audit',
        ...
        issues: {
          ...
          missing: {
            ...
            model: 'Missing Model',
            reasoning_effort: 'Reasoning effort is not set',
          },
        },
      },
    },
    settings: {
      eyebrow: 'Grok Build',
      title: 'Grok Settings',
      subtitle: 'Manage config.toml with field-level patches, or preserve comments and formatting in source mode.',
      back: 'Back to Grok',
      save: 'Save changes',
      saving: 'Saving',
      reload: 'Reload',
      loading: 'Reading Grok configuration...',
      localOnly: {
        title: 'Grok settings are local only',
        description: 'Switch to the local execution environment before reading or changing config.toml on this machine.',
        environment: 'Current environment: {env}',
      },
      tabs: {
        label: 'Grok settings views',
        model: 'Model',
      ...
      managed: {
        title: 'Model defaults are managed by a CCR profile',
        description: 'Active, drifted, and unsafe states lock model fields. Switch profiles or turn profile mode off in Profiles.',
        action: 'Open Profiles',
        rejectedTitle: 'Managed model fields were not saved',
      },
      conflict: {
        title: 'config.toml changed while saving',
        description: 'CCR did not overwrite the external edit. Reload the latest values, then apply these changes again.',
        reload: 'Reload latest',
      },
      model: {
        eyebrow: 'Model defaults',
        title: 'Default model and reasoning effort',
        description: 'When no profile is active, these values are the local Grok defaults.',
      },
      sessionUi: {
        uiEyebrow: 'Interface',
        uiTitle: 'Interface theme',
        uiDescription: 'Controls the Grok interface without changing the CCR theme.',
        sessionEyebrow: 'Session',
        sessionTitle: 'Session behavior',
        sessionDescription: 'Controls context compaction and project environment loading.',
      },
      cli: {
        eyebrow: 'CLI runtime',
        title: 'Updates and tips',
        description: 'Select the update channel and command-line guidance behavior.',
      },
      worktrees: {
        eyebrow: 'Worktrees',
        title: 'Worktree guidance',
        description: 'Choose when new and forked sessions should use a separate worktree.',
      },
      fields: {
        defaultModel: 'Default model',
        ...
        loadEnvrc: 'Load .envrc',
        autoUpdate: 'Automatic updates',
        channel: 'Update channel',
        showTips: 'Show CLI tips',
        newSessionWorktree: 'New-session worktree mode',
        forkWorktree: 'Fork worktree mode',
      },
      placeholders: {
        defaultModel: 'For example, grok-code-fast-1',
      },
      helpers: {
        defaultModel: 'Save an empty value to remove the explicit default.',
        reasoningEffort: 'Supports none, minimal, low, medium, high, xhigh, and max.',
        theme: 'system follows the OS; light and dark fix the display mode.',
        autoCompact: 'An integer from 0 to 100; unset uses the Grok default.',
        loadEnvrc: 'Whether to load the direnv environment when entering a project.',
        autoUpdate: 'Controls automatic Grok CLI update checks.',
        channel: 'stable is intended for daily use; alpha receives releases earlier.',
        showTips: 'Controls usage tips in the command-line interface.',
        newSessionWorktree: 'Worktree guidance for newly created sessions.',
        forkWorktree: 'Worktree guidance when forking an existing session.',
      },
      options: {
        unset: 'Not set',
        enabled: 'On',
      ...
      customModels: {
        ...
        sourceAction: 'Edit in source',
        model: 'Model',
        baseUrl: 'Base URL',
        empty: 'No custom models are defined in config.toml.',
      },
      source: {
        noBackup: 'This file is not backed up automatically. Confirm your version-control or external backup policy before saving.',
        policyNotice: 'Managed or Requirements layers are present. Organization policy may override user settings.',
      },
      footer: {
        moreConfig: 'Use',
        openSource: 'source mode',
        formatting: 'for MCP, permissions, sandboxing, and other sections. Visual saves normalize document formatting and do not preserve comments; save in source mode when exact text matters.',
      },
      validation: {
        autoCompact: 'The auto-compact threshold must be an integer from 0 to 100.',
      },
      messages: {
        loadFailed: 'Failed to load Grok Settings',
        saveSuccess: 'Grok Settings saved',
        saveFailed: 'Failed to save Grok Settings',
      },
    },
    states: {
      notSet: 'Not set',
  ...
  profilesSurface: {
    ...
    offAction: 'Turn profile off',
    offTitle: 'Turn off the current profile',
    offMessage: 'Turn off {name} and clear runtime leftovers that suppress official login? Saved profiles stay.',
    apply: 'Apply',
    edit: 'Edit',
    stop: 'Stop',
    enable: 'Enable',
    ...
    statusIdle: 'Idle',
    allTags: 'All {count}',
    sourceWarningTitle: 'View raw configuration',
    sourceWarningMessage: 'The source file may contain API keys, tokens, or other plaintext secrets. Content stays in page memory only.',
    sourceContinue: 'Continue',
    quickSwitch: 'Quick switch',
    quickRailModifierHint: '{modifier}+number keys to switch',
    quickRailMore: '+{count} more',
    pinProfile: 'Pin {name}',
    unpinProfile: 'Unpin {name}',
    pinLimitReached: 'At most 8 pinned profiles',
    inspectorOpen: 'Open inspector',
    inspectorClosed: 'Close inspector',
    stats: {
      total: 'Total',
      vendors: '{count} vendors',
      running: 'Running',
      runningHint: 'Currently applied profile',
      notApplied: 'Not applied',
      tags: 'Tags',
      auth: 'Auth methods',
    },
    empty: {
      noProfiles: 'No profiles on this platform yet',
      noProfilesHint: 'Create the first profile and write it to the config file.',
      noResults: 'No matching profiles',
      noResultsHint: '{query} {filters} returned no results',
      clearFilters: 'Clear filters',
    },
    view: {
      card: 'Card view',
    ...
    toolbar: {
      searchPlaceholder: 'Search name / description / Base URL / tags',
      statusGroupLabel: 'Status filter',
      tagGroupLabel: 'Tag filter',
      providerLabel: 'Vendor filter',
      providerAll: 'All vendors',
      statusAll: 'All',
      statusActive: 'Current',
      statusEnabled: 'Enabled',
      statusDisabled: 'Disabled',
    ...
    inspector: {
      ariaLabel: 'Profile inspector',
      previewTitle: 'Profile preview',
      editAction: 'Edit this profile',
      previewEmpty: 'Nothing to preview',
      previewEmptyHint: 'Hover or focus a profile to preview it; the current profile is the default.',
      currentBadge: 'Current',
      diffTitle: 'Diff against current',
      sessionWrite: 'Written this session · {time}',
      distributionTitle: 'Distribution',
      providerSection: 'PROVIDER mix',
      authSection: 'AUTH modes',
      tagsSection: 'Top tags',
      unknownProvider: 'Unset',
      noTags: 'No tags',
      auditTitle: 'Health audit',
      auditClean: 'No configuration issues',
      locateAction: 'Locate {name}',
    },
    commandPalette: {
      title: 'Command palette',
  ...
  agentSessions: {
    ...
    subtitle: 'Browse eight local Agent families in one read-only workspace, loading transcript pages only when needed.',
    refresh: 'Incremental refresh',
    refreshing: 'Refreshing incrementally',
    usage: 'View Usage',
    localOnlyTitle: 'Local environment required',
    localOnlyDescription: 'Agent Sessions reads local transcript sources and is unavailable for remote environments.',
    environmentErrorTitle: 'Environment unavailable',
    providers: 'Provider status',
    providerFilterHint: 'Select one or more Agents to filter',
    filters: 'Session filters',
    clearFilters: 'Clear filters',
    search: 'Metadata search',
    searchPlaceholder: 'Search title, session ID, or working directory',
    cwd: 'Working directory',
    cwdPlaceholder: 'Filter by cwd prefix',
    startedAt: 'From date',
    endedAt: 'To date',
    ...
    detailHint: 'Only user, assistant, and structured tool events are shown. System prompts never enter this view.',
    emptyTitle: 'No archived sessions yet',
    emptyDescription: 'Run an incremental refresh or adjust the current filters.',
    selectTitle: 'Select a session',
    selectDescription: 'Choose a session from the list to read its newest messages on demand.',
    loadMore: 'Load more sessions',
    loadOlder: 'Load older messages',
    loadedFind: 'Find in loaded messages',
    localFindHint: 'Searches only transcript pages already loaded',
    messages: '{count} messages',
    tools: '{count} tool events',
    partialNotice: 'Only part of this source can be decoded safely.',
    lockedNotice: 'This source is encrypted and no process key is available. CCR did not bypass or persist a key.',
    clippedNotice: 'This message exceeded the safety cap and was truncated at a valid UTF-8 boundary.',
    refreshComplete: 'Incremental refresh complete',
