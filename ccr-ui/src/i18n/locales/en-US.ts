export default {
  ...
  home: {
    ...
    feature1Desc: 'Unified management for Claude, Codex, Gemini, Droid, and other AI CLI tools',
  ...
  skills: {
    ...
    newToolsTitle: 'New detected platforms found',
    newToolsDescription: '{count} newly detected platforms can receive your managed skills.',
    newToolsAction: 'Select these platforms',
    newToolsDismiss: 'Dismiss for now',
    ...
    refreshingTrending: 'Refreshing Trending...',
    refreshingSearch: 'Refreshing Search...',
    searchResultsTitle: 'Search results for “{query}”',
    searchResultsHint: 'Browse matching skills from the marketplace',
    searchResultCount: '{count} results',
    noTrendingResults: 'No trending skills right now',
    tryRefreshTrending: 'Try refreshing the trending list',
    noPlatformsDetectedShort: 'No platforms detected',
    noDetectedPlatformsTitle: 'No compatible platforms detected',
    noDetectedPlatformsHint: 'Detect at least one supported CLI platform before installing or importing skills.',
    batchInstallCount: 'Install {count} selected skills',
    batchInstallSummary: 'Installed {success}/{total} skills across {platforms} platforms',
    batchInstallFailedCount: '{count} failed',
    batchInstallFailedPackages: '{count} failed: {packages}',
    marketplaceDetailTitle: 'Marketplace Detail',
    marketplaceNotInstalled: 'Not installed yet',
  ...
  converter: {
    ...
    description: 'Convert configurations between Claude Code, Codex, Gemini, Droid, and more',
    backToHome: 'Back to Home',
  ...
  sync: {
    ...
    platformSelection: {
      ...
      droid: 'Factory Droid',
      droidDescription: 'Factory Droid CLI configuration and data',
    },
    ...
    features: {
      ...
      presetPlatformDesc:
        'Config required, Claude/Gemini/Droid optional, one-click setup for common platforms',
  ...
  usage: {
    ...
    dashboard: {
      ...
      cards: {
        ...
        tokensDetail: '{input} in · {output} out',
        totalCost: 'Total Cost',
        costDetail: '{average} per request',
        cacheEfficiency: 'Cache Efficiency',
        cacheDetail: '{tokens} cache read',
      },
      chart: {
      ...
      highlights: {
        ...
        cacheRead: 'Cache Read',
        cacheReadDetail: 'Cache efficiency {percent}',
      },
      rankings: {
      ...
      logs: {
        ...
        diagnostics: {
          ...
          rawLogsHint: 'Use this area to debug imports and aggregation quality, not as the primary analysis surface.',
          ...
          repairCodex: 'Repair Codex history',
          repairingCodex: 'Rebuilding Codex history...',
  ...
  skillsExt: {
    versionHistory: {
      ...
      subtitle: '{count} snapshots · max 50 (FIFO)',
      takeSnapshot: 'Take snapshot',
      refresh: 'Refresh',
      empty: 'No snapshots yet. Edit SKILL.md and save — snapshots are created automatically.',
      rollback: 'Rollback',
      diff: 'Diff',
      baseActive: '◉ Base',
      baseInactive: '○ Base',
      snapshotPrompt: 'Snapshot message',
      defaultMessage: 'manual snapshot',
      rollbackConfirm: 'Rollback to {id} ({message})? Current unsaved state will be auto-snapshotted before rollback.',
    },
    diff: {
      empty: 'Select two snapshots to compare.',
      same: '{count} same',
    },
    trash: {
      title: 'Trash',
      subtitle: '{count} items · 7-day auto-purge',
      empty: 'Trash is empty.',
      restore: 'Restore',
      deleteForever: 'Delete forever',
      deletedAt: 'Deleted {time}',
      expiresAt: 'Auto-purges {time}',
      purgeConfirm: 'Permanently delete this skill from trash? This cannot be undone.',
    },
    toggle: {
      enabled: 'Enabled',
      disabled: 'Disabled',
    ...
    category: {
      title: 'Categories',
      all: 'All',
      empty: 'No categories yet. Run analysis to classify skills.',
    },
    merge: {
      title: 'Merge Suggestions',
      empty: 'No redundant skills detected.',
    },
  },
}
