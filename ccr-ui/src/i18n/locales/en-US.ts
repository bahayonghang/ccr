export default {
  ...
  claudeProfiles: {
    ...
    advancedModelsDescription: 'Maps to ANTHROPIC_DEFAULT_*_MODEL and CLAUDE_CODE_*. Fill these in only when a provider (such as DeepSeek) needs distinct Opus / Sonnet / Haiku routing.',
    advancedModelsToggleExpand: 'Expand advanced model overrides',
    advancedModelsToggleCollapse: 'Collapse advanced model overrides',
    defaultOpusModelLabel: 'Opus default model',
    defaultOpusModelPlaceholder: 'e.g. deepseek-v4-pro',
    defaultOpusModelHelper: 'Sets ANTHROPIC_DEFAULT_OPUS_MODEL. DeepSeek-like services use it to take over the Opus slot.',
    ...
    subagentModelHelper: 'Sets CLAUDE_CODE_SUBAGENT_MODEL for Claude Code internal subagent tasks.',
    effortLevelLabel: 'Effort level',
    effortLevelPlaceholder: 'e.g. max / high / medium / low',
    effortLevelHelper: 'Sets CLAUDE_CODE_EFFORT_LEVEL. Free-form text; no enum enforced.',
