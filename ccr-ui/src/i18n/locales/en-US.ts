export default {
  ...
  home: {
    ...
    footer2: 'Claude Code • Codex • Gemini • Qwen • QODER',
    ...
    qoderTitle: 'QODER',
    qoderDesc: 'Manage Qoder MCP, Commands, Subagents, and Hooks.',
    qoderStats: 'Workflow',
    ...
    posterEyebrow: 'Control surface',
    posterTitle: 'CCR Desktop',
    posterLead: 'Bring commands, config changes, and platform readiness into one calm control console.',
    posterDescription: 'Launch command flows, reshape profiles, sync workspaces, and inspect platform pulse before diving into each module.',
    statusReadyLabel: 'System status',
    statusCliLabel: 'CLI online',
    visualEyebrow: 'Live pulse',
    visualTitle: 'Command fabric',
    visualBadge: 'online',
    usagePreviewEyebrow: 'Activity preview',
    usagePreviewTitle: 'Scroll for the full usage report',
    actionsEyebrow: 'Operate now',
    actionsTitle: 'Start a task',
    actionsDescription: 'Compress the frequent actions into a single strip so the next move is visible immediately.',
    platformsEyebrow: 'Platform control',
    platformsTitle: 'Manage your toolchain',
    platformsDescription: 'Feature the primary nodes, tuck the support lanes aside, and let version state do the scanning work.',
    platformFeatureLabel: 'Primary node',
    systemActivity: 'System Activity',
    usageSectionTitle: 'Usage signal',
    usageSectionDescription: 'The full dashboard still loads on demand below, but the first screen now hints at current activity.',
  ...
  converter: {
    ...
    description: 'Convert configurations between Claude Code, Codex, Gemini, Qwen, Qoder and more',
    backToHome: 'Back to Home',
  ...
  sync: {
    ...
    platformSelection: {
      ...
      qoder: 'Qoder',
      qoderDescription: 'Qoder CLI configuration and data',
    },
  ...
  qoder: {
    overview: {
      ...
      description: 'Qoder CLI · MCP · Commands · Subagents · Hooks',
      backToHome: 'Back to Home',
      features: 'Features',
      feature1:
        'Manage project-level commands via `.qoder/commands`.',
      feature2:
        'Manage reusable subagents via `.qoder/agents`.',
      feature3:
        'Connect MCP servers through `~/.qoder.json` and `.mcp.json`.',
      feature4:
        'Configure Notification hooks and memory via `.qoder/settings.json`.',
      featureTitle: '💡 Qoder CLI Features',
      tags: {
        workflow: '🔄 Agentic Coding',
        orchestration: '⚡ Commands / Hooks',
        mcp: '🔌 MCP Integration',
        agent: '🤖 Subagents',
      },
    },
    mcp: {
      title: 'MCP Servers',
      description: 'Qoder MCP server configuration management',
      badge: '🔌 MCP',
      addServer: 'Add MCP Server',
      editServer: 'Edit MCP Server',
      nameLabel: 'Server Name *',
    ...
    agents: {
      title: 'Subagents',
      description: 'Manage Qoder subagent markdown files',
      badge: '🤖 Subagent',
      folders: {
        label: 'Folders',
        all: 'All',
      ...
      addAgent: 'Add Subagent',
      editAgent: 'Edit Subagent',
      nameLabel: 'Name *',
      namePlaceholder: 'e.g., code-reviewer',
      folderLabel: 'Folder',
      folderPlaceholder: 'Leave empty for root directory',
      descriptionLabel: 'Description',
      descriptionPlaceholder: 'Brief description of this subagent',
      instructionsLabel: 'Prompt *',
      instructionsPlaceholder: 'Enter the subagent system prompt...',
      enabledLabel: 'Enable this subagent',
      searchPlaceholder: 'Search subagent name, description, or prompt...',
      searchResults: 'Found <strong>{count}</strong> matching subagents',
      loading: 'Loading...',
      emptyState: 'No subagents configured',
      noResults: 'No matching subagents found',
      noResultsHint: 'Try using other keywords',
      disabledBadge: 'Disabled',
      enable: 'Enable',
      disable: 'Disable',
      save: 'Save',
      add: 'Add',
      deleteConfirm: 'Are you sure you want to delete subagent "{name}"?',
      validation: {
        required: 'Please fill in required fields',
      },
      messages: {
        ...
        addSuccess: '✓ Subagent added successfully',
    ...
    plugins: {
      title: 'Hooks',
      description: 'Manage Qoder Notification hooks',
      badge: '🪝 Hooks',
      addPlugin: 'Add Hook',
      editPlugin: 'Edit Hook',
      nameLabel: 'Name',
      namePlaceholder: 'Auto generated',
      idLabel: 'Event',
      idPlaceholder: 'Notification',
      versionLabel: 'Type',
      versionPlaceholder: 'command',
      configLabel: 'Command',
      configPlaceholder: '~/notification.sh',
      configHint: 'Qoder currently executes shell commands for Notification hooks.',
      enabledLabel: 'Enable this hook',
      searchPlaceholder: 'Search hook commands...',
      searchResults: 'Found <strong>{count}</strong> matching hooks',
      loading: 'Loading...',
      emptyState: 'No hooks configured',
      ...
      save: 'Save',
      add: 'Add',
      deleteConfirm: 'Are you sure you want to delete hook "{name}"?',
      validation: {
        required: 'Please fill in required fields',
        invalidJson: 'Invalid hook configuration',
      },
      messages: {
        loadFailed: 'Failed to load hooks',
        updateSuccess: '✓ Hook updated successfully',
        addSuccess: '✓ Hook added successfully',
        deleteSuccess: '✓ Hook deleted successfully',
        operationFailed: 'Operation failed: {error}',
        deleteFailed: 'Delete failed: {error}',
        toggleFailed: 'Toggle failed: {error}',
      },
    ...
    slashCommands: {
      title: 'Commands',
      description: 'Manage Qoder markdown commands',
      badge: '⌨️ Commands',
      folders: {
        label: 'Folders',
        all: 'All',
