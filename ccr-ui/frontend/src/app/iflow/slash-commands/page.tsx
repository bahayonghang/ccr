...
export default function IflowSlashCommandsPage() {
  return (
        ...
        <div className="grid grid-cols-[auto_1fr] gap-4">
          ...
          <main className="rounded-xl p-6 glass-effect" style={{ border: '1px solid var(--border-color)', boxShadow: 'var(--shadow-small)' }}>
            <div className="flex items-center gap-3 mb-6">
              ...
              <h1 className="text-2xl font-bold" style={{ color: 'var(--text-primary)' }}>IFLOW - Slash Commands</h1>
            </div>
            ...
            <div className="flex flex-col items-center justify-center py-20">
              ...
              <p className="text-lg mb-2" style={{ color: 'var(--text-secondary)' }}>
                IFLOW Slash Commands 管理功能正在开发中，敬请期待！
              </p>
              <p className="text-sm" style={{ color: 'var(--text-muted)' }}>
                该功能将支持管理 IFLOW 的 Slash Commands 配置
              </p>
            </div>
          </main>
        </div>
