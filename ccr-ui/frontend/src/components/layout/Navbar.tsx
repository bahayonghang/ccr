      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          ...
          {onRefresh && (
            <button
              onClick={onRefresh}
              className="px-4 py-2 rounded-lg font-semibold text-sm transition-all flex items-center space-x-2 hover:scale-105"
              style={{
          ...
          {onAdd && (
            <button
              onClick={onAdd}
              className="px-4 py-2 rounded-lg font-semibold text-sm transition-all flex items-center space-x-2 text-white shadow-lg hover:scale-105"
              style={{
                background: 'linear-gradient(135deg, var(--accent-primary), var(--accent-secondary))',
            ...
            >
              ...
              <span className="hidden sm:inline">添加配置</span>
            </button>
          )}
        </div>
      </div>
