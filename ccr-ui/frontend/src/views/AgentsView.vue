    ...
    <div class="relative z-10 p-6">
      ...
      <div style="display: flex; gap: 0">
        ...
        >
          ...
          <div
            ...
            :style="{
              ...
              cursor: 'pointer',
              marginBottom: '4px',
              background: selectedFolder === folder.value ? 'var(--accent-primary)' : 'transparent',
              color: selectedFolder === folder.value ? '#fff' : 'var(--text-primary)',
              display: 'flex',
              alignItems: 'center',
              gap: '6px',
              transition: 'all 0.2s',
        ...
        <div :style="{ flex: 1, minWidth: 0 }">
          <div
            class="max-w-[1600px] mx-auto p-8 transition-all duration-300"
            :style="{
...
const stats = computed(() => {
  ...
  folders.value.forEach((f) => {
    folderCounts[f] = agents.value.filter((a) => a.folder === f).length
  })
