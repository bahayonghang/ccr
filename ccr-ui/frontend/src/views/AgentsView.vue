        ...
        <div class="max-w-[1600px] mx-auto">
          <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex items-center gap-3">
              ...
              <button class="px-4 py-2 rounded-lg font-medium transition-all hover:scale-105" :style="{ background: 'linear-gradient(135deg, #10b981, #14b8a6)', boxShadow: '0 0 20px rgba(16, 185, 129, 0.3)', color: '#fff' }" @click="handleAdd">
