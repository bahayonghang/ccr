    ...
    <div class="relative z-10 p-6 max-w-7xl mx-auto">
      ...
      <div class="mb-8">
        <div class="flex items-center justify-between mb-6">
          <div class="flex items-center gap-4">
            <div class="p-4 rounded-3xl glass-card" :style="{ background: 'rgba(139, 92, 246, 0.1)' }">
              <Zap class="w-10 h-10" :style="{ color: '#8b5cf6' }" />
            </div>
            <div>
        ...
        <div class="flex flex-wrap gap-3 mb-6">
          ...
          <span class="px-4 py-2 rounded-full text-sm font-medium glass-card" :style="{ background: 'rgba(245, 158, 11, 0.1)', color: '#f59e0b' }">
            🔌 MCP 支持
          </span>
          <span class="px-4 py-2 rounded-full text-sm font-medium glass-card" :style="{ background: 'rgba(239, 68, 68, 0.1)', color: '#ef4444' }">
            🇨🇳 中文优化
          </span>
        </div>
      </div>
      ...
      <div class="mb-8">
        <h2 class="text-2xl font-bold mb-6 flex items-center gap-3" :style="{ color: 'var(--text-primary)' }">
          <Boxes class="w-7 h-7" :style="{ color: '#8b5cf6' }" />
          功能模块
        </h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <RouterLink to="/qwen/mcp" class="block group">
            <div class="glass-card p-6 h-full hover:scale-105 transition-all duration-300">
              <div class="flex items-start gap-4">
                <div class="p-3 rounded-2xl" :style="{ background: 'rgba(139, 92, 246, 0.15)' }">
                  <Server class="w-7 h-7" :style="{ color: '#8b5cf6' }" />
                </div>
                <div class="flex-1">
          ...
          <RouterLink to="/qwen/agents" class="block group">
            <div class="glass-card p-6 h-full hover:scale-105 transition-all duration-300">
              <div class="flex items-start gap-4">
                <div class="p-3 rounded-2xl" :style="{ background: 'rgba(236, 72, 153, 0.15)' }">
                  <Bot class="w-7 h-7" :style="{ color: '#ec4899' }" />
                </div>
                <div class="flex-1">
                  <h3 class="text-xl font-bold mb-2" :style="{ color: 'var(--text-primary)' }">
                    Agents
          ...
          <RouterLink to="/qwen/plugins" class="block group">
            <div class="glass-card p-6 h-full hover:scale-105 transition-all duration-300">
              <div class="flex items-start gap-4">
                <div class="p-3 rounded-2xl" :style="{ background: 'rgba(245, 158, 11, 0.15)' }">
                  <Puzzle class="w-7 h-7" :style="{ color: '#f59e0b' }" />
                </div>
                <div class="flex-1">
                  <h3 class="text-xl font-bold mb-2" :style="{ color: 'var(--text-primary)' }">
                    插件管理
          ...
          <RouterLink to="/qwen/slash-commands" class="block group">
            <div class="glass-card p-6 h-full hover:scale-105 transition-all duration-300">
              <div class="flex items-start gap-4">
                <div class="p-3 rounded-2xl" :style="{ background: 'rgba(239, 68, 68, 0.15)' }">
                  <Command class="w-7 h-7" :style="{ color: '#ef4444' }" />
                </div>
                <div class="flex-1">
                  <h3 class="text-xl font-bold mb-2" :style="{ color: 'var(--text-primary)' }">
                    Slash Commands
      ...
      <div class="glass-card p-6">
        <div class="flex items-start gap-4">
          <div class="p-3 rounded-2xl" :style="{ background: 'rgba(139, 92, 246, 0.15)' }">
            <Info class="w-6 h-6" :style="{ color: '#8b5cf6' }" />
          </div>
          <div class="flex-1">
