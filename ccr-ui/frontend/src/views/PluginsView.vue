        ...
        <main class="rounded-xl p-6 glass-effect" :style="{ border: '1px solid var(--border-color)', boxShadow: 'var(--shadow-small)' }">
          <div class="flex items-center justify-between mb-6">
            <div class="flex items-center gap-3">
              ...
              <div>
                <div class="flex items-center gap-2">
                  ...
                  <span class="px-2 py-1 rounded-full text-xs font-medium" :style="{ background: '#6366f1', color: '#fff' }">{{ plugins.length }}</span>
                </div>
            ...
            <div class="flex items-center gap-3">
              ...
              <button class="px-4 py-2 rounded-lg font-semibold text-sm text-white flex items-center gap-2 transition-all hover:scale-105" :style="{ background: 'linear-gradient(135deg, #6366f1, #8b5cf6)', boxShadow: '0 0 20px rgba(99, 102, 241, 0.3)' }" @click="handleAdd">
