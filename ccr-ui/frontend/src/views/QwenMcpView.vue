        ...
        <main class="rounded-xl p-6 glass-effect" :style="{ border: '1px solid var(--border-color)', boxShadow: 'var(--shadow-small)' }">
          <div class="flex items-center justify-between mb-6">
            <div class="flex items-center gap-3">
              ...
              <h1 class="text-2xl font-bold" :style="{ color: 'var(--text-primary)' }">Qwen MCP 服务器</h1>
            </div>
            <div class="flex items-center gap-3">
          ...
          <div v-else class="space-y-3">
            <div v-if="!servers || servers.length === 0" class="text-center py-10" :style="{ color: 'var(--text-muted)' }">暂无 Qwen MCP 服务器配置</div>
