...
pub async fn get_system_info() -> impl IntoResponse {
    // 使用 spawn_blocking 包装阻塞的系统信息收集操作
    // sysinfo 的 System::new_all() 和 refresh_all() 是阻塞操作
    let info = tokio::task::spawn_blocking(|| {
        ...
        // Wait a bit to get accurate CPU measurements (blocking sleep in spawn_blocking is OK)
