...
[![Version](https://img.shields.io/badge/version-7.3.0-blue.svg)](../Cargo.toml)
...
| --- | --- |
| Bun | `bun@1.4.0` from `package.json#packageManager` |
...
Made with Vue 3, Tauri 2, TypeScript 6.0, Bun, and a restrained editorial surface system.
